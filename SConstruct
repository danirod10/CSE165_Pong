...
opts.Add(PathVariable("target_path", "The path where the lib is installed.", "project/gdnativelib/"))
opts.Add(PathVariable("target_name", "The library name.", "lib_cse165_pong", PathVariable.PathAccept))
